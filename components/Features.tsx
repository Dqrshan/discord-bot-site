...
function Features({}: Props) {
    return (
        <div>
            <section className="text-neutral-400 body-font bg-neutral-800">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap w-full mb-20">
                        ...
                        <p className="lg:w-1/2 w-full leading-relaxed text-neutral-400 text-opacity-90">
                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="xl:w-1/4 md:w-1/2 p-4">
                            <div className="bg-neutral-700 bg-opacity-40 p-6 rounded-lg hover:scale-110">
                                <img
